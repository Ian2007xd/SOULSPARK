const frases = [
    ...
    { texto: "El esfuerzo constante crea resultados extraordinarios.", explicacion: "Los grandes logros no ocurren de un día para otro. La dedicación diaria y el esfuerzo constante son las claves para alcanzar lo extraordinario." },
        { 
            texto: "Cuando el viento no está a tu favor, ajusta tus velas.",
            explicacion: "La vida no siempre sigue nuestros planes, pero podemos adaptarnos. Ajustar nuestro enfoque y dirección nos permite seguir avanzando incluso en contra de la adversidad." 
        },
        { 
            texto: "El cambio empieza en el momento en que decides intentarlo.",
            explicacion: "Todo cambio importante en la vida comienza con una sola decisión: dar el primer paso. El poder de transformar tu vida está en tu voluntad de comenzar." 
        },
        { 
            texto: "El presente es el único momento que puedes cambiar.",
            explicacion: "No podemos alterar el pasado ni controlar el futuro, pero tenemos el poder de actuar en el presente. Cada decisión que tomas hoy moldea tu mañana." 
        },
        { 
            texto: "Dentro de ti hay una fuerza que aún no has descubierto.",
            explicacion: "La fortaleza interior a menudo se revela en los momentos más desafiantes. Eres mucho más capaz de lo que imaginas, solo necesitas enfrentarte a lo desconocido para descubrirlo." 
        },
        { 
            texto: "No puedes cambiar el viento, pero puedes cambiar tu actitud.",
            explicacion: "No podemos controlar todo lo que nos sucede, pero sí podemos controlar cómo respondemos a ello. Nuestra actitud determina cómo enfrentamos los desafíos." 
        },
        { 
            texto: "La paciencia es el arte de seguir creyendo cuando no ves resultados inmediatos.",
            explicacion: "A veces los logros tardan en llegar, pero eso no significa que no estés avanzando. La paciencia y la persistencia son la clave para lograr grandes cosas a largo plazo." 
        },
        { 
            texto: "Lo que parece el final del camino, a menudo es el comienzo de una nueva aventura.",
            explicacion: "A veces, lo que creemos que es un final es solo una nueva etapa que nos llevará a experiencias aún más gratificantes. Los finales también son oportunidades." 
        },
        { 
            texto: "Sigue nadando, incluso cuando no veas la orilla.",
            explicacion: "En la vida, habrá momentos en los que no verás claramente tu destino. Aun así, sigue adelante. La constancia eventualmente te llevará a donde necesitas estar." 
        },
        { 
            texto: "La verdadera fuerza no radica en no caer, sino en levantarse cada vez.",
            explicacion: "Todos enfrentamos caídas en la vida, pero lo que realmente nos define es nuestra capacidad de levantarnos una y otra vez, con más determinación que antes." 
        },
        { 
            texto: "Cree en la posibilidad de lo imposible.",
            explicacion: "Las barreras más grandes a menudo están en nuestra mente. Si crees que algo es posible, abrirás las puertas a oportunidades que antes parecían inalcanzables." 
        },
        { 
            texto: "El coraje es la chispa que enciende el fuego del cambio.",
            explicacion: "Nada en la vida cambia sin el primer acto de coraje. Cuando te atreves a enfrentar tus miedos, enciendes el poder transformador dentro de ti." 
        },
        { 
            texto: "El éxito no se mide por lo rápido que llegas, sino por cuánto disfrutas el camino.",
            explicacion: "La vida no es una carrera de velocidad, sino un viaje de crecimiento y aprendizaje. Disfrutar cada paso es lo que realmente te llevará al éxito." 
        },
        { 
            texto: "Las cicatrices son recordatorios de lo lejos que has llegado.",
            explicacion: "Cada cicatriz, ya sea física o emocional, es una marca de tu valentía y resistencia. Son testimonios de las batallas que has superado y de tu capacidad para seguir adelante." 
        },
        { 
            texto: "A veces, perder es la forma en que el universo te guía hacia algo mejor.",
            explicacion: "No todas las derrotas son finales. A veces, perder algo es la manera en que la vida nos redirige hacia algo más alineado con nuestro verdadero propósito." 
        },
        { 
